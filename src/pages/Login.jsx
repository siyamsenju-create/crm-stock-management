      ...
      <div className="hidden lg:flex h-screen w-full">
        ...
        <section className="w-1/2 flex items-center justify-center p-12 bg-surface">
          <div className="w-full max-w-[448px] space-y-6">
            ...
            {/* Google SSO */}
            <button 
              className="w-full bg-white border border-[#c6c5d8] hover:border-[#0605bf] text-on-surface font-body-md py-3.5 rounded-xl shadow-sm hover:shadow-md active:scale-[0.98] transition-all flex items-center justify-center gap-3 cursor-pointer"
              type="button"
      ...
      <div className="flex lg:hidden min-h-screen flex-col items-center justify-center px-6 py-12 font-body-md overflow-x-hidden select-none">
        ...
        <main className="relative z-10 w-full max-w-[380px] flex flex-col items-center">
          ...
          <section className="w-full bg-[#ffffff] border border-[#c6c5d8]/40 rounded-2xl p-6 shadow-[0_8px_30px_rgba(0,0,0,0.06)]">
            ...
            {/* Google Login */}
            <button 
              className="w-full h-12 bg-[#f9f9ff] border border-[#c6c5d8]/60 hover:bg-[#f0f3ff] text-[#111c2d] font-semibold text-xs rounded-xl flex items-center justify-center gap-3 active:scale-[0.98] transition-all cursor-pointer"
              type="button"
              onClick={handleGoogleSSO}
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24">
