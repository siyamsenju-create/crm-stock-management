...
export default function TopBar({ onMenuClick }) {
    ...
    return (
        <header className="flex justify-between items-center px-4 md:px-8 sticky top-0 z-40 ml-0 md:ml-64 w-full md:w-[calc(100%-16rem)] h-16 bg-white/90 backdrop-blur-md shadow-sm border-b border-outline-variant">
            <div className="flex items-center gap-4 flex-1">
                <button 
                    onClick={onMenuClick}
                    className="p-2 -ml-2 text-on-surface-variant hover:bg-surface-container rounded-lg md:hidden flex items-center justify-center"
            ...
            <div className="flex items-center gap-4 ml-4">
                ...
                <button onClick={() => navigate('/settings')} className="hidden sm:block text-on-surface-variant hover:text-primary transition-colors">
